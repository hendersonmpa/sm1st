...
make_ts("Ala", alaqc, alarrf)
alamoi <- get_viewdata("Ala", query_moi)
make_ts("Ala", alamoi, alarrf, moi = TRUE)
...
make_ts("Arg", argqc, argrrf)
argmoi <- get_viewdata("Arg", query_moi)
make_ts("Arg", argmoi, argrrf, moi = TRUE)
...
make_ts("ASA", asaqc, asarrf)
asamoi <- get_viewdata("ASA", query_moi)
make_ts("ASA", asamoi, asarrf, moi = TRUE)
...
make_ts("Cit", citqc, citrrf)
citmoi <- get_viewdata("Cit", query_moi)
make_ts("Cit", citmoi, citrrf, moi = TRUE)
...
make_ts("Met", metqc, metrrf)
metmoi <- get_viewdata("Met", query_moi)
make_ts("Met", metmoi, metrrf, moi = TRUE)
...
make_ts("Phe", pheqc, pherrf)
phemoi <- get_viewdata("Phe", query_moi)
make_ts("Phe", phemoi, pherrf, moi = TRUE)
...
make_ts("Tyr", tyrqc, tyrrrf)
tyrmoi <- get_viewdata("Tyr", query_moi)
make_ts("Tyr", tyrmoi, tyrrrf, moi = TRUE)
...
make_ts("SUAC", suacqc, suacrrf)
suacmoi <- get_viewdata("SUAC", query_moi)
make_ts("SUAC", suacmoi, suacrrf, moi = TRUE)
...
make_ts("GUAC", guacqc, guacrrf)
guacmoi <- get_viewdata("GUAC", query_moi)
make_ts("GUAC", guacmoi, guacrrf, moi = TRUE)
...
make_ts("C0", c0qc, c0rrf)
c0moi <- get_viewdata("C0", query_moi)
make_ts("C0", c0moi, c0rrf, moi = TRUE)
...
make_ts("C2", c2qc, c2rrf)
c2moi <- get_viewdata("C2", query_moi)
make_ts("C2", c2moi, c2rrf, moi = TRUE)
...
make_ts("C3", c3qc, c3rrf)
c3moi <- get_viewdata("C3", query_moi)
make_ts("C3", c3moi, c3rrf, moi = TRUE)
...
make_ts("C5", c5qc, c5rrf)
c5moi <- get_viewdata("C5", query_moi)
make_ts("C5", c5moi, c5rrf, moi = TRUE)
...
make_ts("C5DC", c5dcqc, c5dcrrf)
c5dcmoi <- with_con(query_moi , view_params)
make_ts("C5DC", c5dcmoi, c5dcrrf, moi = TRUE)
...
make_ts("C6", c6qc, c6rrf)
c6moi <- get_viewdata("C6", query_moi)
make_ts("C6", c6moi, c6rrf, moi = TRUE)
...
make_ts("C8", c8qc, c8rrf)
c8moi <- get_viewdata("C8", query_moi)
make_ts("C8", c8moi, c8rrf, moi = TRUE)
...
make_ts("C10", c10qc, c10rrf)
c10moi <- get_viewdata("C10", query_moi)
make_ts("C10", c10moi, c10rrf, moi = TRUE)
...
make_ts("C141", c141qc, c141rrf)
c141moi <- get_viewdata("C14:1", query_moi)
make_ts("C141", c141moi, c141rrf, moi = TRUE)
...
make_ts("C16", c16qc, c16rrf)
c16moi <- get_viewdata("C16", query_moi)
make_ts("C16", c16moi, c16rrf, moi = TRUE)
...
make_ts("C16OH", c16ohqc, c16ohrrf)
c16ohmoi <- get_viewdata("C16OH", query_moi)
make_ts("C16OH", c16ohmoi, c16ohrrf, moi = TRUE)
...
make_ts("C18", c18qc, c18rrf)
c18moi <- get_viewdata("C18", query_moi)
make_ts("C18", c18moi, c18rrf, moi = TRUE)
...
make_ts("SUAC_QC", suacqc, suacqcrrf)
make_ts("SUAC_QC", suacmoi, suacqcrrf, moi = TRUE)
...
make_ts("GUAC_QC", guacqc, guacqcrrf)
make_ts("GUAC_QC", guacmoi, guacqcrrf, moi = TRUE)

## C5
c5lowqc <- subset(c5qc, sample != "APPOS2")
c5qcrrf <- find_rrf(c5lowqc, c5lin)
make_plots("C5_QC", c5pop, c5lin, c5qcrrf, 0.2, 0.7 )
make_ts("C5_QC", c5qc, c5qcrrf)
make_ts("C5_QC", c5moi, c5qcrrf, moi = TRUE)
